...
export default function Resistor({ firstColor, secondColor, multiplierColor, toleranceColor, firstValue, secondValue, multiplierValue, toleranceValue }) {
  ...
  return (
    <svg width="442" height="182" viewBox="0 0 442 182" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M131 94C131 98.4183 127.418 102 123 102L72.7317 102C68.5856 102 65.1265 98.8323 64.7626 94.7022L61.7049 60H17L17 85H2V60V50C2 47.2386 4.23858 45 7 45H17H61.6168L64.7626 9.29783C65.1265 5.16769 68.5855 2.00001 72.7317 2.00001L123 2C127.418 2 131 5.58172 131 10L131 17H311V10C311 5.58172 314.582 2 319 2H369.268C373.414 2 376.874 5.16769 377.237 9.29783L380.383 45H425H435C437.761 45 440 47.2386 440 50V60V85H425V60H380.295L377.237 94.7022C376.874 98.8323 373.414 102 369.268 102H319C314.582 102 311 98.4183 311 94V87H131V94Z"/>
      </mask>
      ...
      <text id="1" x="96" y="167" width="30" height="30" dominant-baseline="central" text-anchor="middle" fill="#fff">{firstValue}</text>
      </g>
      <g id="Second Square">
      <rect id="Rectangle 58" x="147" y="87" width="20" height="65" fill={secondColor} fill-opacity="0.4"/>
